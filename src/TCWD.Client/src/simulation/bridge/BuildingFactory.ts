...
const MAT_PARK_GROUND = new THREE.MeshStandardMaterial({ color: 0xc0dabe, roughness: 1.0, metalness: 0.0, fog: false });
const MAT_PARK_TREE = new THREE.MeshStandardMaterial({ color: 0xb8d8b8, roughness: 0.9, metalness: 0.0, fog: false });
const MAT_PARK_TRUNK = new THREE.MeshStandardMaterial({ color: 0xc8beb4, roughness: 0.95, metalness: 0.0, fog: false });
